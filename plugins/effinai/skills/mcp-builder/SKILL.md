---
name: mcp-builder
description: "Design and ship production-ready MCP servers from API contracts. Convert OpenAPI specs to MCP tool definitions, generate server scaffolds, validate manifests, and enforce versioning."
version: "1.0.0"
tags: [mcp, api, server, openapi, integration, tooling]
createdBy: "built-in"
status: "active"
---
...
Supports both Python and TypeScript MCP implementations and treats OpenAPI as the source of truth.
...
Checks include: duplicate names, invalid schema shape, missing descriptions, empty required fields, naming hygiene.

### 3. Runtime Selection

- **Python** for fast iteration and data-heavy backends
- **TypeScript** for unified JS stacks and tighter frontend/backend contract reuse

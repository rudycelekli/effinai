...
description: "Systematic performance profiling for Node.js, Python, and Go applications. Identifies CPU, memory, and I/O bottlenecks; generates flamegraphs; analyzes bundle sizes; optimizes database queries; detects memory leaks; runs load tests."
version: "1.0.0"
tags: [performance, profiling, optimization, benchmarking, load-testing]
createdBy: "built-in"
status: "active"
---
...
When the user mentions slow apps, high latency, memory leaks, bundle size issues, or needs load testing before a launch.
...
Establish baseline BEFORE any optimization. Record: P50, P95, P99 latency | RPS | error rate | memory usage.
